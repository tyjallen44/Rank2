...
def collect_platform_data(
    ...
    for p in practices:
        ...
        g_rating, g_count = google_data.get(name, (None, None))
        ...
        for platform in _PLATFORMS:
            ...
            if r is not None and c:
                ...
                platforms_found.append(platform.capitalize() if platform != "webmd" else "WebMD")
        ...
        con.execute(
            """INSERT INTO practice_reputation_practices
               (id, rep_run_id, practice_name, city, state, affiliation_verified,
                google_rating, google_count, healthgrades_rating, healthgrades_count,
                vitals_rating, vitals_count, webmd_rating, webmd_count,
                yelp_rating, yelp_count, ratemds_rating, ratemds_count,
            ...
            [
                ...
                p.get("google_rating"), p.get("google_count"),
                p.get("healthgrades_rating"), p.get("healthgrades_count"),
                p.get("vitals_rating"), p.get("vitals_count"),
                p.get("webmd_rating"), p.get("webmd_count"),
                p.get("yelp_rating"), p.get("yelp_count"),
                p.get("ratemds_rating"), p.get("ratemds_count"),
