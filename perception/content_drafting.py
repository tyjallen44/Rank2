...
_SYSTEM = (
    ...
    "   - reputation_program: a concrete review-generation plan for the specific location "
    "(HIPAA-compliant patient review-request message templates, cadence, and which platform to "
    "direct patients to), plus a short review-response template. Never fabricate review text or "
    "patient quotes.\n"
